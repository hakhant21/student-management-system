...
@section('title','အကြံပြုချက်အမျိုးအစားများအသစ်ဖန်တီး')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                <form id="quickForm" action="{{ route('admin.recommendation_types.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">အကြံပြုချက်အမျိုးအစား</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="အကြံပြုချက်အမျိုးအစားအမည်">
                        </div>
                    </div>
