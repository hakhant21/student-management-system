    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <form id="quickForm" action="{{ route('admin.image_types.update', $image_type->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $image_type->name }}"
                                id="name" placeholder="ဓာတ်ပုံအမည်... ဥပမာ - ကျောင်းသူ/သား၏ မှတ်ပုံတင် ဓါတ်ပုံ">
