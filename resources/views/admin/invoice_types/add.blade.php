...
@section('title', 'ငွေတောင်းခံလွှာအမျိုးအစားအသစ်ဖန်တီး')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <form id="quickForm" action="{{ route('admin.invoice_types.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                placeholder="ငွေတောင်းခံလွှာအမျိုးအစားအမည်">
